...
docs/
  HORATAD.md                    ← HORATAD: stack, version bump, cache-bust, SW policy, UI rules, quirks
  BIBLE_MISSION.md              ← BIBLE roadmap + milestone
  JULIAN_MISSION.md             ← JULIAN schema + task series
  CASE_STUDIES.md               ← PDCA experiment log
  CHANGELOG.md                  ← version history (V3.2.x → V3.3.x)
  UI_LAYOUT.md                  ← wireframe + annotation ราย ID ทุกหน้า
