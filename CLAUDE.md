...
6. **จบ session** → อัปเดต `handoffs/<PROJECT>_<YYYYMMDD>_v<n>.md` + `PROJECT_STATUS.md`
   - **BIBLE session**: อัปเดต `handoffs/BIBLE_memory.md` ก่อนสร้าง handoff เสมอ
     เพิ่มสิ่งที่เรียนรู้ใหม่: คำศัพท์ใหม่, pattern ใหม่, กฎที่ค้นพบ, ข้อสังเกตเกี่ยวกับภาษา

### 📚 BIBLE_memory — Project-specific memory (อ่านและเขียนอัตโนมัติ)

ไฟล์ `handoffs/BIBLE_memory.md` เป็น **domain knowledge ถาวร** ของ project BIBLE  
ต่างจาก handoff (task state) เพราะไม่มี expiry และสะสมเพิ่มทุก session

| เวลา | action | บังคับ |
|---|---|---|
| ต้น session BIBLE | อ่าน `handoffs/BIBLE_memory.md` | ✅ ก่อนทำงานใดๆ |
| ระหว่าง session | ถ้าพบคำศัพท์/pattern/กฎใหม่ → note ไว้ก่อน | — |
| ก่อนสร้าง handoff | อัปเดต `handoffs/BIBLE_memory.md` ก่อน | ✅ ทุก session |

**สิ่งที่เพิ่มลง BIBLE_memory เมื่อพบ:**
